...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-zinc-50">
    <head>
        ...
        <title>{{ config('app.name', 'PostPilot') }} - Log In</title>
        ...
        <div class="min-h-screen flex flex-col lg:flex-row overflow-hidden">
            ...
            <main class="flex-grow flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-zinc-50">
                ...
                <div class="w-full max-w-sm bg-white border border-zinc-200 rounded-2xl p-8 sm:p-10 shadow-[0_8px_30px_rgba(0,0,0,0.02)] space-y-8" style="max-width: 380px;">
                    ...
                    @if (session('status'))
                        <div class="bg-zinc-50 border border-zinc-200 rounded-lg p-4 text-xs text-zinc-800 font-medium">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-xs font-bold text-zinc-500 hover:text-black transition-colors">
                                        Forgot Password?
                                    </a>
                                @endif
                            </div>
                        ...
                        <div class="flex items-center">
                            <input
                                ...
                                type="checkbox"
                                name="remember"
                                class="w-4 h-4 text-black border-zinc-350 rounded focus:ring-black/10 focus:ring-2"
                            />
                            <label for="remember_me" class="ml-2 text-xs font-semibold text-zinc-500 select-none">
                        ...
                        <div class="text-center pt-2">
                            <p class="text-zinc-500 text-sm font-medium">
                                ...
                                <a href="{{ route('register') }}" class="text-black hover:underline font-bold transition-colors">
                                    Sign up for free
                                </a>
                            </p>
                        </div>
