...
@section('title', $seo['title'] ?? 'Free LinkedIn Bold & Italic Text Generator [No Sign-Up] – Unicode Formatter | PostPilot')
@section('meta_description', $seo['meta_description'] ?? 'Make your LinkedIn posts & headlines stand out with bold and italic unicode text. Instant formatting, copy & paste ready. 100% free, no account needed ➔')
...
<div class="mb-16 font-sans" x-data="unicodeFormatter()">
    ...
    <section class="flex flex-col items-center text-center gap-4 max-w-3xl mx-auto mb-10 font-sans">
        ...
        <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-black tracking-tight leading-tight font-sans text-center">
            {{ $seo['h1'] ?? 'LinkedIn Bold & Italic Unicode Text Generator' }}
        </h1>
    ...
    <div class="max-w-3xl mx-auto mb-8 px-4 sm:px-0">
        <p class="text-[15px] leading-relaxed text-gray-700 font-medium bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
            <strong>What is this tool?</strong> {{ $seo['answer_first'] ?? 'The LinkedIn Bold & Italic Unicode Text Generator is a free utility that transforms standard text into stylized Unicode fonts, including bold, italic, script, and monospace. Creators use it to bypass LinkedIn\'s native formatting limitations, adding visual hierarchy to post hooks and bios to instantly capture reader attention in crowded feeds.' }}
        </p>
    </div>
